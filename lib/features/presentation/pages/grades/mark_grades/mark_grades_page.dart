...
class MarkGradePage extends StatefulWidget {
  static const route = '/mark-grade';

  const MarkGradePage({super.key});

  @override
  State<MarkGradePage> createState() => _MarkGradePageState();
}

class _MarkGradePageState extends State<MarkGradePage> {
  Future<void> _getData() async {
    if (!mounted) return;
    final bloc = context.read<ClassIndexBloc>();
    bloc.add(GetClassesByIdEvent(uid: UserConfigUtil.uid));
  }
